...
ggplot(nation, aes(x = reorder(factor(COUNTRY), COUNTRY, function(x) length(x)))) + 
  ...
  theme(text = element_text(),axis.text.x = element_text(angle = 45, hjust = 1)) + 
...
Inspired by the aforementioned literature
and also personal experiences, we would like to <b>see if musical sophistication influences
the perception of beauty</b>. We hypothesize that <b>higher scores for music sophistication will
align with higher scores for beauty</b>. Furthermore, we will <b>analyze the potential
correlation between said scores and genre preference</b>.
...
STOMP and Class graph shows the relation between genre and class (‘Likers’,
‘Indifferents’, ‘Dislikers’).

The main conclusion to draw from this graph is that Intense &amp; Rebellious has the highest
percentage of ‘Dislikers’ out of all genre groups. In contrast, the Reflective &amp; Complex and
Energetic &amp; Rhythmic genres were more popular with the ‘Likers’ and ‘Indifferents’, but
have the lowest percentages of ‘Dislikers’.

In general, Upbeat &amp; Conventional is the most popular genre group and was roughly
equally appreciated by all groups.
After considering the age and gender of the participants, we found that there were no
significant differences in their responses. As a result, these graphs are not shown here.
...
**<u>Familiar vs Unfamiliar Songs</u>** <br>
...
**<u>More Intense & Rebellious Songs</u>**<br>
...
**<u>The Confounder of Instrument Learning Experience</u>** <br>
...
**<u>Objective vs Subjective Beauty</u>** <br>
...
**<u>Correlation vs Causal Relationship</u>** <br>
