...
Features_wide$Feature <- factor(Features_wide$Feature, levels = c("Melody", "Tonalness", "Articulation", "Intensity", "Pitch", "Rhytmic.Clarity", "Tempo", "Rhythmic.Complexity", "Mode"), labels = c("Melody", "Tonalness", "Articulation", "Intensity", "Pitch", "Rhythmic Clarity", "Tempo", "Rhythmic Complexity", "Mode"))
