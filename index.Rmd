...
```{r}
ggplot(genre.p, aes(x=genre.preference)) + geom_bar() + theme(axis.text.x = element_text(size=8, angle = 45, hjust = 1)) + ggtitle("genre preferences") + ylab("number of times genre mentioned in preferences")
```
...
--------------------------------------------------
### LCA class table
  ![The LCA Class table](LCA_table.png)
