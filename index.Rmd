...
ggplot(tky, aes(colour=cut(`p adj`, c(0, 0.01, 0.05, 1), 
  ...
  labs(colour="") + ylab("Difference in Gold-MSI") + xlab("Pair") + Theme_experimental + theme(legend.background = element_rect(fill = "#2c5c8b")) + coord_flip()
```
